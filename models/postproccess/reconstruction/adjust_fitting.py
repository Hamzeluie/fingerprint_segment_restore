...
from reconstruction.point_match import final
from reconstruction.ridge_restoration import one2one, one2many, thinning
from reconstruction.one2one_adjust import one2one_candidates
import cv2
import math
import numpy as np
...
if __name__ == '__main__':
    path = '/home/naserwin/hamze/fingerprint_segment_restore/results/postproccess/result-img_06-mask_06_thin.png'

    background, new_img = draw_whole_img(path)
    thick_img = thick(new_img)
    cv2.imwrite("/home/naserwin/new_img.png", new_img)
    cv2.imwrite("/home/naserwin/thick_img.png", thick_img)
    cv2.imwrite("/home/naserwin/background.png", background)
